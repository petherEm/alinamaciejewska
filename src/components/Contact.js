        ...
        <div className="container">
          ...
          <div className="contact_inner">
            <div className="left wow fadeInUp" data-wow-duration=".7s">
              <div className="text">
                <p>
                  Masz ciekawe pomysły badawcze w obszarze gospodarki przestrzennej, geodezji bądź ochrony gruntów. Zapraszam do bezpośredniego kontaktu.
                </p>
              </div>
              <div className="short">
                <ul>
                  <li>
                    <div className="list_inner">
                      ...
                      <span>pl. Politechniki 1, Politechnika Warszawska</span>
                    </div>
                  </li>
                  <li>
                    <div className="list_inner">
                  ...
                  <li>
                    <div className="list_inner">
                      ...
                      <span>www.alinamaciejewska.com</span>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="fields">
                ...
                >
                  ...
                  <div className="first">
                    <ul>
                      <li>
                        <input id="name" type="text" placeholder="Nazwisko" />
                      </li>
                      <li>
